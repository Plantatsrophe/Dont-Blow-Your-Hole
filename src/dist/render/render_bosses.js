 ...
 */
function drawFiberStrands(points, strandCount, colorHue, isFlipped, alpha = 0.8, boss, isMedusa = false, broadness = 1.0, tallness = 0.0, baseSpread = 0.0, isVertical = false) {
